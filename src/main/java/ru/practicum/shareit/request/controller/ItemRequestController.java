...
public class ItemRequestController {
    ...
    public ItemRequestDto createItemRequest(@RequestHeader(value = "X-Sharer-User-Id", defaultValue = "0") Long userId,
    ...
    @ResponseStatus(HttpStatus.OK)
    public ItemRequestDto updateItemRequest(@RequestHeader(value = "X-Sharer-User-Id", defaultValue = "0") Long userId,
                                            @RequestBody ItemRequestDto itemRequestDto,
    ...
    @ResponseStatus(HttpStatus.OK)
    public String deleteRequest(@RequestHeader(value = "X-Sharer_User-Id", defaultValue = "0") Long userId,
                                @PathVariable(value = "requestId") Long requestId) {
    ...
    @ResponseStatus(HttpStatus.OK)
    public ItemRequestDto findRequestById(@RequestHeader(value = "X-Sharer-User-Id", defaultValue = "0") Long uesrId,
                                          @PathVariable(value = "requestId") Long requestId) {
    ...
    @GetMapping
    @ResponseStatus(HttpStatus.OK)
    public List<ItemRequestDto> findAllUserRequests(@RequestHeader(value = "X-Sharer-User-Id",
    ...
    @GetMapping("/all")
    @ResponseStatus(HttpStatus.OK)
    public List<ItemRequestDto> findAllRequests(@RequestHeader(value = "X-Sharer-User-Id", defaultValue = "0") Long userId,
